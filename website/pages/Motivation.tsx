...
const Motivation = () => {
  return (
    <Section
      id="motivation"
      className="items-start justify-start flex-col lg:flex-col"
    >
      <Title text="Motivation" />
      <p className="text-grey text-md lg:text-xl pb-7">
      ...
      <p className="text-grey text-md lg:text-xl pb-7">
        I like to take inspiration from game developers cause in my opinion
        they&apos;re the most motivated/inspiring developers 😊.
      </p>
      <p className="text-grey text-md lg:text-xl pb-7">
        This video was about asking successful game developers on how they think
        about productivity and the results were <strong>fascinating</strong>,
        they all agreed on <strong>Deadlines</strong> as the most effective
      ...
      <ul className="text-grey list-disc list-inside text-md lg:text-xl pb-7">
        <li className="mb-2">Limited customizations</li>
        <li className="mb-2">I’ve to start it whenever I boot up my OS</li>
        <li className="mb-2">
